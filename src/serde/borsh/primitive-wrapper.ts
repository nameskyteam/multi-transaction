...
export type BorshWrapper<T> = { __inner__: T; unwrap(): T };
 ...
 */
export function wrapper(data: string, type: 'string'): BorshWrapper<string>;
/**
 ...
 * @param type BorshType
 */
export function wrapper(data: number, type: 'u8' | 'u16' | 'u32' | 'f32' | 'f64'): BorshWrapper<number>;
/**
 ...
 * @param type BorshType
 */
export function wrapper(data: bigint, type: 'u64' | 'u128' | 'u256' | 'u512'): BorshWrapper<bigint>;
/**
 ...
 * @param type BorshType
 */
export function wrapper(data: boolean, type: 'bool'): BorshWrapper<boolean>;
/**
 ...
 * @param type BorshType
 */
export function wrapper(data: Buffer, type: BorshArrayU8 | BorshVecU8): BorshWrapper<Buffer>;
/**
 ...
 * @param type BorshType
 */
export function wrapper<T>(data: T[], type: BorshArray | BorshVec): BorshWrapper<T[]>;
/**
 ...
 * @param type BorshType
 */
export function wrapper<T>(data: T | undefined, type: BorshOption): BorshWrapper<T | undefined>;
export function wrapper<T>(data: T, type: BorshType): BorshWrapper<T>;
export function wrapper<T>(data: T, type: BorshType): BorshWrapper<T> {
